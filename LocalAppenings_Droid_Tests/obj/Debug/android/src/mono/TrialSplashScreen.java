package localappenings_droid_tests.localappenings_droid_tests;
...
public class TrialSplashScreen extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen.this, localappenings_droid_tests.MainActivity.class);
